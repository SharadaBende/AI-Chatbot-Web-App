...
function Register({ onRegister, goToLogin }) {
  ...
  const checkboxBg = darkMode ? "border-gray-600" : "border-gray-300";

  return (
    <div className={`min-h-screen ${bg} flex items-center justify-center px-4 py-8 transition-colors duration-300`}>
      ...
      <div className="w-full max-w-md">
        ...
        <h1 className={`${text} text-3xl font-semibold text-center mb-2`}>Create an account</h1>
        <p className={`${subtext} text-center mb-8 text-sm`}>Start chatting with AI today</p>
        ...
        <div className={`${card} rounded-2xl p-8 border shadow-2xl`}>
          ...
          {/* Email */}
          <div className="mb-4">
            <label className={`${label} text-sm mb-2 block font-medium`}>Email</label>
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Password */}
          <div className="mb-4">
            <label className={`${label} text-sm mb-2 block font-medium`}>Password</label>
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {strength && (
              <div className="mt-2">
                ...
                <p className={`text-xs mt-1 ${subtext}`}>Password strength: <span className="font-medium">{strength.label}</span></p>
              </div>
            )}
          </div>
          ...
          {/* Confirm Password */}
          <div className="mb-5">
            <label className={`${label} text-sm mb-2 block font-medium`}>Confirm Password</label>
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <input
                ...
                onKeyDown={handleKeyDown}
                className={`w-full ${input} border rounded-xl pl-10 pr-10 py-3 text-sm outline-none transition ${
                  confirm && password !== confirm ? "border-red-500" : confirm && password === confirm ? "border-green-500" : ""
                }`}
              />
          ...
          <div className="flex items-start gap-3 mb-6">
            <input
              ...
              className={`mt-0.5 w-4 h-4 accent-purple-500 cursor-pointer border ${checkboxBg} rounded`}
            />
            <label htmlFor="terms" className={`${subtext} text-sm cursor-pointer`}>
              I agree to the{" "}
        ...
        <p className={`text-center ${subtext} text-sm mt-6`}>
          ...
          <span onClick={goToLogin} className="text-purple-500 cursor-pointer hover:underline font-medium">
            Sign in
          </span>
        </p>
